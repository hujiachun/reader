...
public class UiAutomatorHelper {
    ...
    public static void main(String[] args) {
		UiAutomatorHelper ui = new UiAutomatorHelper("reader", "ReaderSanityTestCase", "test003Recommend", "3");
	}
...
//		modfileBuild();
	...
	*/
	...
	public void buildWithAnt() {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					Runtime.getRuntime().exec("TASKKILL /F /IM find.exe");
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
	...
	public void pushTestJar(String localPath) {
		...
		String pushCmd = "adb push " + localPath + " /sdcard/";
	...
	public void runTest(String jarName, String testName) {
		String runCmd = "adb shell uiautomator runtest  /sdcard/";
		String testCmd = jarName + ".jar " + "-c com.meizu.reader.test." + testName;
